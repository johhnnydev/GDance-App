...
@section('content')
	{!! Form::open(['id' => 'form', 'action' => 'FatherController@store', 'method' => 'POST']) !!}
    {{ csrf_field() }}
	...
	<div class="form-row">
	    <div class="col-md-3{{ $errors->has('father_fname') ? ' has-error' : '' }}">
	        ...
	        {{Form::text('father_fname', '', ['class' => 'form-control', 'placeholder' => 'First Name', 'required'])}}
	    ...
	    <div class="col-md-3{{ $errors->has('father_mname') ? ' has-error' : ''}} ">
	        ...
	        {{Form::text('father_mname', '', ['class' => 'form-control', 'placeholder' => 'Middle Name', 'required'])}}
	    ...
	    <div class="col-md-3{{ $errors->has('father_lname') ? ' has-error' : ''}} ">
	        ...
	        {{Form::text('father_lname', '', ['class' => 'form-control', 'placeholder' => 'Last Name', 'required'])}}
	    ...
	    <div class="col-md-3{{ $errors->has('father_suffix') ? ' has-error' : ''}} ">
	        ...
	        {{Form::text('father_suffix', '', ['class' => 'form-control', 'placeholder' => 'ex. jr'])}}
	...
	<div class="form-row">
        <div class="col-md-12{{ $errors->has('father_address') ? ' has-error' : '' }}">
            ...
            {{Form::text('father_address', '', ['class' => 'form-control', 'placeholder' => 'Present Address', 'required'])}}
	...
	<div class="form-row">	
		<div class="col-md-4{{ $errors->has('father_birthday') ? ' has-error' : '' }}">
		    ...
		    {{Form::date('father_birthday', '', ['class' => 'form-control', 'placeholder' => '', 'required'])}}
		...
		<div class="col-md-4{{ $errors->has('father_age') ? ' has-error' : '' }}">
		    ...
		    {{Form::number('father_age', '', ['class' => 'form-control', 'placeholder' => 'Age', 'min' => '1', 'required'])}}
	...
	<div class="form-row">		
		<div class="col-md-6{{ $errors->has('father_nationality') ? ' has-error' : '' }}">
			...
			{{Form::text('father_nationality', '', ['class' => 'form-control', 'placeholder' => 'Nationality', 'required'])}}
		...
		<div class="col-md-6{{ $errors->has('father_religion') ? ' has-error' : '' }}">
			...
			{{Form::text('father_religion', '', ['class' => 'form-control', 'placeholder' => 'Religion', 'required'])}}
	...
	<div class="form-row">
		<div class="col-md-6{{ $errors->has('father_working_status') ? ' has-error' : '' }}">
	        ...
	        {{Form::select('father_working_status', ['Locally Employed' => 'Locally Employed', 'Abroad(OFW)' => 'Abroad (OFW)', 'Businessman/Home-Based' => 'Businessman/Home-Based', 'Not Working' => 'Not Working'], null, ['class' => 'form-control', 'placeholder' => 'Working Status', 'required'])}}
		...
		<div class="col-md-6{{ $errors->has('father_occupation') ? ' has-error' : '' }}">
		    ...
		    {{Form::text('father_occupation', '', ['class' => 'form-control', 'placeholder' => 'Occupation', 'required'])}}
	...
	<div class="form-row">		
		<div class="col-md-12{{ $errors->has('father_company_contact') ? ' has-error' : '' }}">
		    ...
		    {{Form::text('father_company_contact', '', ['class' => 'form-control', 'placeholder' => 'Company address or Contact Number'])}}
	...
	<div class="form-row">
		<div class="col-md-6{{ $errors->has('father_education') ? ' has-error' : '' }}">
		    ...
		    {{Form::text('father_education', '', ['class' => 'form-control', 'placeholder' => 'Highest Educational Attainment', 'required'])}}
		...
		<div class="col-md-6{{ $errors->has('father_degree') ? ' has-error' : '' }}">
		    ...
		    {{Form::text('father_degree', '', ['class' => 'form-control', 'placeholder' => 'Degree'])
		    }}
	...
	<div style="margin-bottom: 10px;" class="form-row">
		<div class="col-md-6{{ $errors->has('father_contact_number') ? ' has-error' : '' }}">
		    ...
		    {{Form::text('father_contact_number', '', ['class' => 'form-control', 'placeholder' => 'Contact Number', 'required'])}}
		...
		<div class="col-md-6{{ $errors->has('father_email_address') ? ' has-error' : '' }}">
		    ...
		    {{Form::email('father_email_address', '', ['class' => 'form-control', 'placeholder' => 'E-Mail Address', 'required'])}}
