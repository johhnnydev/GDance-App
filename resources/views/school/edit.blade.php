...
@section('content')
	...
	{!! Form::open(['id' => 'form', 'action' => ['SchoolRecordController@update', $schoolrecord->id], 'method' => 'POST']) !!}
	{{ csrf_field() }}
		...
		<div class="form-group row">
			...
			<div class="col-md-10">
				{{Form::text('school_elem', $schoolrecord->school_elem, ['class' => 'form-control', 'placeholder' => 'Elementary School', 'required'])}}
		...
		<div class="form-group row">
			...
			<div class="col-md-10">
				{{Form::text('school_elem_years', $schoolrecord->school_elem_years, ['class' => 'form-control', 'placeholder' => '2010-2017', 'required'])}}
		...
		<div class="form-group row">
			...
			<div class="col-md-10">
				{{Form::text('school_junior', $schoolrecord->school_junior, ['class' => 'form-control', 'placeholder' => 'Junior High School'])}}
		...
		<div class="form-group row">
			...
			<div class="col-md-10">				
				{{Form::text('school_junior_years', $schoolrecord->school_junior_years, ['class' => 'form-control', 'placeholder' => '2010-2017'])}}
		...
		<div class="form-group row">
			...
			<div class="col-md-10">				
				{{Form::text('school_senior', $schoolrecord->school_senior, ['class' => 'form-control', 'placeholder' => 'Senior High School','required'])}}
			</div>
		</div>
		<div class="form-group row">
			<div class="col-md-2">								
			...
			<div class="col-md-10">								
				{{Form::text('school_senior_years', $schoolrecord->school_senior_years, ['class' => 'form-control', 'placeholder' => '2010-2017'])}}
			</div>
		</div>	
		...
		<div class="form-group row">
			...
			<div class="col-md-10">				
				{{Form::text('school_college', $schoolrecord->school_college, ['class' => 'form-control', 'placeholder' => 'College'])}}
			</div>
		</div>
		<div class="form-group row">
			<div class="col-md-2">								
			...
			<div class="col-md-10">								
				{{Form::text('school_college_years', $schoolrecord->school_college_years, ['class' => 'form-control', 'placeholder' => '2010-2017'])}}
			</div>
		</div>
		<div class="form-group row">
			<div class="col-md-2">									
			...
			<div class="col-md-10">											
				{{Form::text('school_college_course', $schoolrecord->school_college_course, ['class' => 'form-control', 'placeholder' => 'B.S. Accounting'])}}
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-md-10">				
				{{Form::text('easy_subjects', $schoolrecord->easy_subjects, ['class' => 'form-control', 'placeholder' => 'Easiest Subject/s Handled'])}}
			</div>
		</div>
		<div class="form-group row">
			<div class="col-md-2">								
			...
			<div class="col-md-10">				
				{{Form::text('difficult_subjects', $schoolrecord->difficult_subjects, ['class' => 'form-control', 'placeholder' => 'Difficult Subject/s Handled'])}}
			</div>
		</div>	
