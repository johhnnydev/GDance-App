...
@section('content')
	...
	{!! Form::open(['id' => 'form', 'action' => ['MotherController@update', $mother->id], 'method' => 'POST']) !!}
	    {{ csrf_field() }}
		...
		<div class="form-row">
            <div class="col-md-3{{ $errors->has('mother_fname') ? ' has-error' : '' }}">
                ...
                {{Form::text('mother_fname', $mother->mother_fname, ['class' => 'form-control', 'placeholder' => 'First Name', 'required'])}}
            ...
            <div class="col-md-3{{ $errors->has('mother_mname') ? ' has-error' : ''}} ">
                ...
                {{Form::text('mother_mname', $mother->mother_mname, ['class' => 'form-control', 'placeholder' => 'Middle Name', 'required'])}}
            ...
            <div class="col-md-3{{ $errors->has('mother_lname') ? ' has-error' : ''}} ">
                ...
                {{Form::text('mother_lname', $mother->mother_lname, ['class' => 'form-control', 'placeholder' => 'Last Name', 'required'])}}
            ...
            <div class="col-md-3{{ $errors->has('mother_suffix') ? ' has-error' : ''}} ">
                ...
                {{Form::text('mother_suffix', $mother->mother_suffix, ['class' => 'form-control', 'placeholder' => 'ex. jr'])}}
        ...
        <div class="form-row">
            <div class="col-md-12{{ $errors->has('mother_address') ? ' has-error' : '' }}">
                ...
                {{Form::text('mother_address', $mother->mother_address, ['class' => 'form-control', 'placeholder' => 'Present Address', 'required'])}}
        ...
        <div class="form-row">  
            <div class="col-md-4{{ $errors->has('mother_birthday') ? ' has-error' : '' }}">
                ...
                {{Form::date('mother_birthday', $mother->mother_birthday, ['class' => 'form-control', 'placeholder' => '', 'required'])}}
            ...
            <div class="col-md-4{{ $errors->has('mother_age') ? ' has-error' : '' }}">
                ...
                {{Form::number('mother_age', $mother->mother_age, ['class' => 'form-control', 'placeholder' => 'Age', 'min' => '1', 'required'])}}
            ...
            <div class="col-md-4{{ $errors->has('mother_civil_status') ? ' has-error' : '' }}">
                ...
                Separated', 'Widowed' => 'Widowed'], $mother->mother_civil_status, ['class' => 'form-control', 'placeholder' => 'Civil Status', 'required'])}}
        ...
        <div class="form-row">      
            <div class="col-md-6{{ $errors->has('mother_nationality') ? ' has-error' : '' }}">
                ...
                {{Form::text('mother_nationality', $mother->mother_nationality, ['class' => 'form-control', 'placeholder' => 'Nationality', 'required'])}}
            ...
            <div class="col-md-6{{ $errors->has('mother_religion') ? ' has-error' : '' }}">
                ...
                {{Form::text('mother_religion', $mother->mother_religion, ['class' => 'form-control', 'placeholder' => 'Religion', 'required'])}}
        ...
        <div class="form-row">
            <div class="col-md-6{{ $errors->has('mother_working_status') ? ' has-error' : '' }}">
                ...
                {{Form::select('mother_working_status', ['Locally Employed' => 'Locally Employed', 'Abroad(OFW)' => 'Abroad (OFW)', 'Businessman/Home-Based' => 'Businessman/Home-Based', 'Not Working' => 'Not Working'], $mother->mother_working_status, ['class' => 'form-control', 'placeholder' => 'Working Status', 'required'])}}
            ...
            <div class="col-md-6{{ $errors->has('mother_occupation') ? ' has-error' : '' }}">
                ...
                {{Form::text('mother_occupation', $mother->mother_occupation, ['class' => 'form-control', 'placeholder' => 'Occupation', 'required'])}}
        ...
        <div class="form-row">      
            <div class="col-md-12{{ $errors->has('mother_company_contact') ? ' has-error' : '' }}">
                ...
                {{Form::text('mother_company_contact', $mother->mother_company_contact, ['class' => 'form-control', 'placeholder' => 'Company address or Contact Number'])}}
        ...
        <div class="form-row">
            <div class="col-md-6{{ $errors->has('mother_education') ? ' has-error' : '' }}">
                ...
                {{Form::text('mother_education', $mother->mother_education, ['class' => 'form-control', 'placeholder' => 'Highest Educational Attainment', 'required'])}}
            ...
            <div class="col-md-6{{ $errors->has('mother_degree') ? ' has-error' : '' }}">
                ...
                {{Form::text('mother_degree', $mother->mother_degree, ['class' => 'form-control', 'placeholder' => 'Degree'])
                }}
        ...
        <div style="margin-bottom: 10px;" class="form-row">
            <div class="col-md-6{{ $errors->has('mother_contact_number') ? ' has-error' : '' }}">
                ...
                {{Form::text('mother_contact_number', $mother->mother_contact_number, ['class' => 'form-control', 'placeholder' => 'Contact Number', 'required'])}}
            ...
            <div class="col-md-6{{ $errors->has('mother_email_address') ? ' has-error' : '' }}">
                ...
                {{Form::email('mother_email_address', $mother->mother_email_address, ['class' => 'form-control', 'placeholder' => 'E-Mail Address', 'required'])}}
