...
@section('content')
			...
			<form method="POST" action="/absentreport">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-2">
						...
						<input style="cursor: pointer;" type="submit" value="Download as Excel" class="btn btn-success form-control">
					</div>
				</div>				
			</form>
		</div>
	...
	<div class="card border-light card-shadow">
		<div class="card-body">
			<h1 class="text-primary">Absent Report</h1>
			<form method="POST" action="/absentpdf">
				{{ csrf_field() }}
				<div class="form-row">
					<div class="form-group col">
						<label for="usn">USN</label>
					...
					<div class="form-group col-md-2">
						<label style="visibility: hidden;">hidden</label>
						<input style="cursor: pointer;" type="submit" value="Download as PDF" class="btn btn-danger form-control">
					</div>
				</div>				
			</form>
		</div>
