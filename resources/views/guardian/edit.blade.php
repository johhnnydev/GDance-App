...
@section('content')
	{!! Form::open(['id' => 'form', 'action' => ['GuardianController@update', $guardian->id], 'method' => 'POST']) !!}
	    {{ csrf_field() }}
		...
		<div class="form-row">
            <div class="col-md-3{{ $errors->has('guardian_fname') ? ' has-error' : '' }}">
                ...
                {{Form::text('guardian_fname', $guardian->guardian_fname, ['class' => 'form-control', 'placeholder' => 'First Name', 'required'])}}
            ...
            <div class="col-md-3{{ $errors->has('guardian_mname') ? ' has-error' : ''}} ">
                ...
                {{Form::text('guardian_mname', $guardian->guardian_mname, ['class' => 'form-control', 'placeholder' => 'Middle Name', 'required'])}}
            ...
            <div class="col-md-3{{ $errors->has('guardian_lname') ? ' has-error' : ''}} ">
                ...
                {{Form::text('guardian_lname', $guardian->guardian_lname, ['class' => 'form-control', 'placeholder' => 'Last Name', 'required'])}}
            ...
            <div class="col-md-3{{ $errors->has('guardian_suffix') ? ' has-error' : ''}} ">
                ...
                {{Form::text('guardian_suffix', $guardian->guardian_suffix, ['class' => 'form-control', 'placeholder' => 'ex. jr'])}}
        ...
        <div class="form-row">
            <div class="col-md-12{{ $errors->has('guardian_address') ? ' has-error' : '' }}">
                ...
                {{Form::text('guardian_address', $guardian->guardian_address, ['class' => 'form-control', 'placeholder' => 'Present Address', 'required'])}}
        ...
        <div class="form-row">  
            <div class="col-md-4{{ $errors->has('guardian_birthday') ? ' has-error' : '' }}">
                ...
                {{Form::date('guardian_birthday', $guardian->guardian_birthday, ['class' => 'form-control', 'placeholder' => '', 'required'])}}
            ...
            <div class="col-md-4{{ $errors->has('guardian_age') ? ' has-error' : '' }}">
                ...
                {{Form::number('guardian_age', $guardian->guardian_age, ['class' => 'form-control', 'placeholder' => 'Age', 'min' => '1', 'required'])}}
            ...
            <div class="col-md-4{{ $errors->has('guardian_civil_status') ? ' has-error' : '' }}">
                ...
                Separated', 'Widowed' => 'Widowed'], $guardian->guardian_civil_status, ['class' => 'form-control', 'placeholder' => 'Civil Status', 'required'])}}
        ...
        <div class="form-row">      
            <div class="col-md-6{{ $errors->has('guardian_nationality') ? ' has-error' : '' }}">
                ...
                {{Form::text('guardian_nationality', $guardian->guardian_nationality, ['class' => 'form-control', 'placeholder' => 'Nationality', 'required'])}}
            ...
            <div class="col-md-6{{ $errors->has('guardian_religion') ? ' has-error' : '' }}">
                ...
                {{Form::text('guardian_religion', $guardian->guardian_religion, ['class' => 'form-control', 'placeholder' => 'Religion', 'required'])}}
        ...
        <div class="form-row">
            <div class="col-md-6{{ $errors->has('guardian_working_status') ? ' has-error' : '' }}">
                ...
                {{Form::select('guardian_working_status', ['Locally Employed' => 'Locally Employed', 'Abroad(OFW)' => 'Abroad (OFW)', 'Businessman/Home-Based' => 'Businessman/Home-Based', 'Not Working' => 'Not Working'], $guardian->guardian_working_status, ['class' => 'form-control', 'placeholder' => 'Working Status', 'required'])}}
            ...
            <div class="col-md-6{{ $errors->has('guardian_occupation') ? ' has-error' : '' }}">
                ...
                {{Form::text('guardian_occupation', $guardian->guardian_occupation, ['class' => 'form-control', 'placeholder' => 'Occupation', 'required'])}}
        ...
        <div class="form-row">      
            <div class="col-md-12{{ $errors->has('guardian_company_contact') ? ' has-error' : '' }}">
                {{Form::label('guardian_company_contact', 'Company Address and Contact no.', ['class' => 'col-form-label'])}}
                {{Form::text('guardian_company_contact', $guardian->guardian_company_contact, ['class' => 'form-control', 'placeholder' => 'Company address or Contact Number'])}}
        ...
        <div class="form-row">
            <div class="col-md-6{{ $errors->has('guardian_education') ? ' has-error' : '' }}">
                ...
                {{Form::text('guardian_education', $guardian->guardian_education, ['class' => 'form-control', 'placeholder' => 'Highest Educational Attainment', 'required'])}}
            ...
            <div class="col-md-6{{ $errors->has('guardian_degree') ? ' has-error' : '' }}">
                ...
                {{Form::text('guardian_degree', $guardian->guardian_degree, ['class' => 'form-control', 'placeholder' => 'Degree'])
                }}
        ...
        <div style="margin-bottom: 10px;" class="form-row">
            <div class="col-md-6{{ $errors->has('guardian_contact_number') ? ' has-error' : '' }}">
                {{Form::label('guardian_contact_number', 'Contact Number', ['class' => 'col-form-label'])}}
                {{Form::text('guardian_contact_number', $guardian->guardian_contact_number, ['class' => 'form-control', 'placeholder' => 'Contact Number', 'required'])}}
            ...
            <div class="col-md-6{{ $errors->has('guardian_email_address') ? ' has-error' : '' }}">
                {{Form::label('guardian_email_address', 'Email Adress', ['class' => 'col-form-label'])}}
                {{Form::email('guardian_email_address', $guardian->guardian_email_address, ['class' => 'form-control', 'placeholder' => 'E-Mail Address', 'required'])}}
                <small class="text-danger">{{ $errors->first('guardian_email_address') }}</small>
            </div>
        </div>
